...
insert ∷ (Num ⨯ Tree Num) → Tree Num | Tree Num [(e1^1) |-> 1/2, (x^1) |-> 1, x ↦ 1, (2) |-> 3] → Tree Num [e1 ↦ 1]
...
meld ∷ (Tree Num ⨯ Tree Num) → Tree Num | Tree Num [x ↦ 1, y ↦ 1, (e1^1) ↦ 1/2, (x^1) |-> 1/2, (y^1) |-> 1/2] → Tree Num [e1 ↦ 1] (*{Tree Num [] -> Tree Num []}*)
