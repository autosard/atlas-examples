...
insert ∷ (Num ⨯ Tree Num) → Tree Num | Tree Num [(e1^1) |-> 105/163, (x^1) ↦ 3115/7824, x ↦ 1, (2) |-> 23803/7824] → Tree Num [e1 ↦ 1]
insert a x = (meld (node leaf a leaf) x)



{-# STRONGCF #-}
delete_min ∷ Tree Num → Tree Num | Tree Num [(e1^1) ↦ 105/163, (x^1) |-> 3115/3912, x ↦ 1] → Tree Num [e1 ↦ 1]
